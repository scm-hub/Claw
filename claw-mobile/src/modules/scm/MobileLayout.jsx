...
import { getNavItems, getRoleGroupName, ROLE_GROUPS } from './navConfig';
...
const PAGE_TITLES = {
  '/scm': '鲜当家SCM',
  '/scm/inventory': '库存管理',
  '/scm/sales-orders': '销售订单',
  '/scm/sales-plans': '销售计划',
  '/scm/purchase-orders': '采购订单',
  '/scm/receivables': '应收账款',
  '/scm/payables': '应付账款',
  '/scm/scan-inbound': '扫码入库',
  '/scm/stock-take': '盘点管理',
  '/scm/approval-center': '审批中心',
  '/scm/shipping': '发货管理',
  '/scm/settings': '设置',
};
